...
import { 
  ...
  SiFigma, SiPostman, // Icons import kora holo
  SiZap
} from 'react-icons/si'
  ...
  const SkillCard = ({ skill, index }) => {
    ...
    return (
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="bg-white/5 p-5 rounded-2xl border border-white/10 hover:border-primary/50 transition-all"
      >
  ...
  return (
    <section id="skills" className="py-14 bg-surface/20" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <h3 className="text-3xl md:text-4xl font-bold italic">Technical Expertise</h3>
          <div className="w-20 h-1 bg-primary mx-auto mt-4 rounded-full" />
        </motion.div>

        <div className="mb-12">
          <h4 className="text-lg font-medium mb-6 text-white/60 border-l-4 border-primary pl-4">Frontend Development</h4>
        ...
        <div className="mb-20">
          <h4 className="text-lg font-medium mb-6 text-white/60 border-l-4 border-primary pl-4">Backend & Database</h4>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className="text-center pt-10 border-t border-white/5">
          <h4 className="text-sm font-semibold mb-10 text-white/40 tracking-[0.2em] uppercase">Tools & Environment</h4>
            ...
            {tools.map((tool, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[10px] text-white/30 group-hover:text-white/80 transition-colors uppercase tracking-widest">{tool.name}</span>
                </motion.div>
              )
            })}
          </div>
